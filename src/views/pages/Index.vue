    ...
    <div class="content-page home">
        <div class="content">
            ...
            <div v-show="theme_config.other.module.banner" class="row banner mt-1 mt-md-0">
                ...
                <div :class="2 != 0 ? 'col-lg-4' : 'col-lg-12'" id="home-mark-card">
                    <div class="card mb-lg-3 mb-2 first">
                        <div class="card-body py-2">
                            <h3 class="page-title display-7 animated fadeInUp"></h3>
                            <p class="text-muted mb-0 flex align-items-center justify-content-space-between">
                                <span>
                                    <span class="text-muted">凤兮凤兮归故乡，遨游四海求其凰。 —— 李白</span>
                                </span>
                            </p>
                        </div>
                    </div>
                    <div class="card ribbon-box second">
                        <div class="card-body">
                            ...
                            <span>
                                <span class="span-text">我是一个码农，擅长将代码之舞演绎得惊心动魄。作为初级架构师，我犹如一位代码的雕塑家，能够将混乱的需求塑造成优雅而高效的软件架构。我从编程的摇篮起步，迷恋于问题的解决。随着岁月的积淀，我驾驭Java语言的能力日益精湛，掌握面向对象编程的精髓，探索设计模式和架构原则的深层奥妙。作为一名勇于挑战的架构师，我善于将庞杂的系统拆解成可管理的模块，以创新设计的智慧打造出高度可扩展的结构。我的代码不仅仅是一串冰冷的指令，而是一个精巧的交响乐，展现出卓越的性能和可维护性。我对于解决技术难题有着执着的追求，不断探索新技术的边界。我熟悉常用的Java框架和工具，如微服务、高并发、大数据，善于在开发过程中灵活运用它们。</span>
                            </span>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div v-else-if="!is_mobile" v-for="data in article_data" class="col-md-6 col-xl-3 un-mobile" >
